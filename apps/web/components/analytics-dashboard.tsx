...
export function AnalyticsDashboard() {
    ...
    const COLORS = ['#d8b4fe', '#a5f3fc', '#86efac', '#fcd34d', '#fca5a5'];
                ...
                >
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={analytics.automationPerformance}>
                            ...
                            />
                            <Legend />
                            <Bar dataKey="triggers" fill="#c084fc" name="Trigger Count" />
                            <Bar dataKey="successRate" fill="#86efac" name="Success Rate (%)" />
                        </BarChart>
                    </ResponsiveContainer>
                </motion.div>
                ...
                >
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={analytics.hourlyPerformance}>
                            ...
                            />
                            <Bar dataKey="count" fill="#a5f3fc" name="Messages" />
                        </BarChart>
                    </ResponsiveContainer>
                </motion.div>
            </div>
